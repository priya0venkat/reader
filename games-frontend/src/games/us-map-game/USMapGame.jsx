                ...
                <div className="complete-screen">
                    ...
                    <p className="complete-message">
                        {accuracy === 100 ? "Perfect score! You're a geography master! 🌟" :
                            accuracy >= 80 ? "Great job! You know your states well! 👏" :
    ...
    return (
        <div className="app">
            ...
            <div className="progress-container">
                <div className="progress-text">State {currentStateIndex + 1} of {shuffledStates.length}</div>
                <div className="progress-bar">
                    <div className="progress-fill" style={{ width: `${((currentStateIndex + 1) / shuffledStates.length) * 100}%` }} />
                </div>
            </div>
        </div>
    );
