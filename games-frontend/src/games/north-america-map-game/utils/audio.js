...
/**
 * Announces the state name for the player to find
 * @param {string} stateName - Name of the state
 */
export const announceState = (stateName) => {
    speak(`Find ${stateName}`, 0.9, 1);
};

/**
 * Provides feedback when the correct state is clicked
 */
...
/**
 * Provides feedback when the wrong state is clicked
 */
...
export const playCelebrationSound = () => {
    speak('Congratulations! You found all the countries!', 1, 1.1);
