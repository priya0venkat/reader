...
var ONNX_BASE = "https://cdnjs.cloudflare.com/ajax/libs/onnxruntime-web/1.18.0/";
...
var _TtsSession = class _TtsSession2 {
  ...
  async init() {
    const { createPiperPhonemize } = await import("./piper-o91UDS6e-HUTTRJC3.js");
    __privateSet(this, _createPiperPhonemize, createPiperPhonemize);
    __privateSet(this, _ort, await import("./ort.bundle.min-MWX4R4F5.js"));
...
async function voices() {
  try {
    ...
    const LOCAL_VOICES_JSON = await import("./voices_static-D_OtJDHM-LGSOKBXD.js");
...
//# sourceMappingURL=@mintplex-labs_piper-tts-web.js.map
